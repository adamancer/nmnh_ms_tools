...
@deprecated("Use nmnh_ms_tools.records.catnums.CatNum() instead")
class CatNum(Record):
...
@deprecated("Use nmnh_ms_tools.records.catnums.parse_catnum() instead")
...
@deprecated("Use nmnh_ms_tools.records.catnums.parse_catnums() instead")
...
@deprecated("Use nmnh_ms_tools.records.catnums.is_antarctic() instead")
@functools.lru_cache()
