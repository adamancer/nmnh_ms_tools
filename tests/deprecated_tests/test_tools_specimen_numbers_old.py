...
from nmnh_ms_tools.tools.specimen_numbers_old.parser import Parser
from nmnh_ms_tools.tools.specimen_numbers_old.utils import is_spec_num
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "USNM 200935b, c; 201025a; 201130; 201148; 203520b",
            [
                "USNM 200935B",
                "USNM 200935C",
                "USNM 201025A",
        ...
        (
            "NMNH 123456-59",
            ["NMNH 123456", "NMNH 123457", "NMNH 123458", "NMNH 123459"],
        ),
        (
            "USNM 123343b, d-f; 123344d-j",
            [
                "USNM 123343B",
                "USNM 123343D",
                "USNM 123343E",
        ...
        (
            "USNM 123343a, c; 123344a, c",
            ["USNM 123343A", "USNM 123343C", "USNM 123344A", "USNM 123344C"],
        ),
        ("USNM 201 1 16a", ["USNM 201116A"]),
        (
            "NMNH specimens 112345 through 112348",
            ["NMNH 112345", "NMNH 112346", "NMNH 112347", "NMNH 112348"],
        ),
        ("USNM 426-l and HU-1", ["USNM 426-1"]),
        (
            "NMNH No. 11742-00, 11743-00, and 11745-00",
            ["NMNH 11742-00", "NMNH 11743-00", "NMNH 11745-00"],
        ),
        (
            "USNM 200961, 200982a, c, e, 201182a-e, 201183a, 201184",
            [
                "USNM 200961",
                "USNM 200982A",
                "USNM 200982C",
        ...
        (
            "...figured paratypes USNM 201 1 17, 201 1 19, 201 120, 201 123. Discussion...",
            ["USNM 201117", "USNM 201119", "USNM 201120", "USNM 201123"],
        ),
        (
            "...8 holotype **USNM 76238; 1** P paratype **USNM 76239**...",
            ["USNM 76238", "USNM 76239"],
        ),
        (
            "...bout 40 ° N. 70 °. **USNM 112700 112779-112783**. Actinoc...",
            [
                "USNM 112700",
                "USNM 112779",
                "USNM 112780",
        ...
        (
            "...Hypotypes figured by Cooper (1954) USNM 123358; 123359a-c; 123361a; 123363a; 123364; 123365a, b; 123366a, b; 123367; 123368a; 123369a; 123370a...",
            [
                "USNM 123358",
                "USNM 123359A",
                "USNM 123359B",
        ...
        (
            "...of MHNJP 708 709 USNM 504332 571257 and 5 7 12 5 8 with sk...",
            ["USNM 504332", "USNM 571257", "USNM 571258"],
        ),
        (
            "...Unfigured Paratypes USNM 200901b-e, 201I29d-h...",
            [
                "USNM 200901B",
                "USNM 200901C",
                "USNM 200901D",
        ...
        (
            "USNM 112686-112688 112729-112733 112735",
            [
                "USNM 112686",
                "USNM 112687",
                "USNM 112688",
        ...
        (
            "USNM 222269--73 247305--11 247632--3 343241 268946--53",
            [
                "USNM 222269",
                "USNM 222270",
                "USNM 222271",
        ...
        (
            ...
            ["USNM 3369", "USNM 13823", "USNM 345225", "USNM 346582", "USNM 489406"],
        ),
        ...
        (
            ...
            ["USNM 111240-52", "USNM 113087"],
        ),
        ("NMNH 84021, ANSP 1832; 5", ["NMNH 84021"]),
        (
            "NMNH 91234, UNAM 1808, MCZ 10807, 32868, UM 79938",
            ["NMNH 91234", "MCZ 10807", "MCZ 32868", "MCZ UM 79938"],
        ),
        (
            "FMNH  22088, 22359, 161121, 216745, YPM 12870; O",
            [
                "FMNH 22088",
                "FMNH 22088",
                "FMNH 22359",
        ...
        ),  # FMNH YPM 12870 is incorrect but acceptable by the parser at present
        (
            "USNM 12345, 12348, NMNH 12346, USNH 12347",
            ["USNM 12345", "USNM 12348", "NMNH 12346", "USNH 12347"],
        ),
        ("USNM12345, 12346", ["USNM 12345", "USNM 12346"]),
        (
            "...Kentropyx calcarata FMNH 31352. 42523.  NMNH 292411. 292412. Lacerta lepida...",
            ["FMNH 31352", "FMNH 42523", "NMNH 292411", "NMNH 292412"],
        ),
        (
            '...Maria Madre Island, AMNH 180522, NMNH  92413; "Tres Marias...',
            ["AMNH 180522", "NMNH 92413"],
        ),
        ("...paratype (USNM 2i 1807), length...", ["USNM 211807"]),
        (
            "...right valve (USNM  21,1812). length 7.0 mm, (d) left, valve (USNM 21,1815), length  7.0 mm...",
            ["USNM 211812", "USNM 211815"],
        ),
        ...
        (
            "Museum San Carlos olivine (USNM 111312/444). Moreover, Jeﬀcoate et al. (2007",
            ["USNM 111312-444"],
        ),
        ...
        (
            "...USNM 118223. Santander: El Centro, USNM 144968-9; Finca El Mosco, near Lebrija...",
            ["USNM 118223", "USNM 144968", "USNM 144969"],
        ),
        (
            "...(Map 8); 3 (USNM 26192-93); 69 (USNM 153449-68, 153510-27); 70 (USNM 153486-509); 71 (USN...",
            [
                "USNM 153449",
                "USNM 153450",
                "USNM 153451",
        ...
        (
            "...few cervicals, but it also lacks the skull. Referred specimens USNM 7760, 7761, 8065, 8016, and 5031 are even more fragmentary, and...",
            ["USNM 5031", "USNM 7760", "USNM 7761", "USNM 8016", "USNM 8065"],
        ),
        (
            "...4 Aug 1979; j. D. Hardy, hunter in col 1ector. Stuvniva lilium USNM 00538023-63, St. John Parish, various localities, July, 1979; G...",
            [
                "USNM 538023",
                "USNM 538023-5T",
                "USNM 538024",
        ...
        (
            ...
            ["AMNH 94493", "FMNH 121498", "FMNH 121499", "USNM 192727"],
        ),
        (
            "...FMNH 2061 14. Barisia imbricata NMNH 32166. Basiliscus basiliscus FMNH 164...",
            ["FMNH 164", "FMNH 206114", "NMNH 32166"],
        ),
        (
            "...21, 1968 from the same locality; USNM 192877 is a male collected on June 30, 1968...",
            ["USNM 192877"],
        ),
        (
            "USNM 113027/43, 113027/353, 113028/0103, 113028/05",
            ["USNM 113027-353", "USNM 113027-43", "USNM 113028-0103", "USNM 113028-05"],
        ),
        (
            "..Junin: Same data as holotype: FMNH 34242/1-23, 34247, 11 males, 4 females, 9 juveniles...",
            [
                "FMNH 34242-1",
                "FMNH 34242-10",
                "FMNH 34242-11",
        ...
        (
            "History, Washington, D.C., USA accession number USNM slide 223101.  Type locality",
            ["USNM slide no. 223101"],
        ),
        (
            "ALH85003 from NASA, Johnson Space Center, Houston; USNM 6264-1 of Colony, USNM",
            ["USNM 6264-1"],
        ),
        (
            "paratypes (USNM 234314, 1099 and 10~<~)have been deposited",
            ["USNM 1099", "USNM 234314"],
        ),
        (
            "International mineral and obsidian standards such as USNM 7285, KN18, and KE12 (Nielsen",
            ["USNM 7285"],
        ),
        (
