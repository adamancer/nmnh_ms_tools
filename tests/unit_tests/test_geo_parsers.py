...
from nmnh_ms_tools.tools.geographic_names.parsers.junction import (
    get_road,
    get_junction
)
from nmnh_ms_tools.tools.geographic_names.parsers.feature import (
    append_feature_type
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            'Border of King Co. and Kittitas Co.', marks=pytest.mark.xfail
        ),
    ]
)
...
@pytest.mark.parametrize(
    'test_input',
    ['Chestnut St', 'WA Route 97', 'WA Rt 97', 'WA 97']
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('37 km E of Riberalta on road to Guayaramerin',
         ['37 km E of Riberalta']),
        ...
        ('Fayetteville, SSW of, ca. 3.4 mi (by road)',
         ['SSW of Fayetteville']),
        ...
        ('Indianola Is. To Gallinipyer Point. Lavaca And Matagorda Bays',
         ['Indianola Is',
          ...
          'Lavaca Bay',
          'Matagorda Bay']),
        ('Lamont Geological Observatory, core A167-25, on slope of Blake '
         'Plateau',
